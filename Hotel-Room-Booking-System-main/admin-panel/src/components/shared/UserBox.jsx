...
function UserBox() {
  ...
  return (
    ...
    <div className='logo-box' onClick={() => navigate('/main/profile')}>
      <img className='w-[50px] h-auto rounded-full' src={user?.avatar || Avatar} crossOrigin='anonymous' alt='avatar-img' />
